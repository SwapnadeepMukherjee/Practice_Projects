# Question 1: # WAP to perform index-wise addition for the resulting list -
...
# Question 2 - WAP to find whether a list is unique or not. The function should take the list as an input parameter
