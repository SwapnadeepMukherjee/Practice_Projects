...
# 	3. Imagine you have huge dataset and we have setup a Python code that is giving out correct output that is designed with nested loops only. How do you optimize the code? : Pandas, Numpy, List Comprehension, …
